package com.OnlineAdmissionSystemDemo.App.Controllers;
...
import com.OnlineAdmissionSystemDemo.App.Exception.DeletionException;
import com.OnlineAdmissionSystemDemo.App.Exception.NotFoundException;
import com.OnlineAdmissionSystemDemo.App.Exception.PaymentAddException;
import com.OnlineAdmissionSystemDemo.App.Services.IPaymentServices;
...
public class OnlineAdmissionSystemController {
	...
	@ApiParam(value="Id of the payment to be uploaded",required = true) @RequestBody Payment payment) {
		System.out.println("Controller" + payment);
